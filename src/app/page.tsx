      ...
      <header className="sticky top-0 z-50 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="mx-auto flex h-14 max-w-3xl items-center justify-between px-4">
          ...
          <div className="flex gap-1 sm:gap-2">
            ...
            <Link href="/register">
              <Button size="sm" className="px-2 sm:px-3">Registrieren</Button>
            </Link>
          </div>
        </div>
      </header>
      ...
      <main className="flex-1">
        ...
        <section className="border-t bg-muted/30 px-4 py-16">
          <div className="mx-auto max-w-sm space-y-8">
            <div className="text-center space-y-2">
              <h2 className="text-2xl font-bold">Kostenlose Beta</h2>
              <p className="text-muted-foreground">
                Während der Beta ist KlassHub komplett kostenlos.
              </p>
            </div>
            <div className="relative rounded-xl border-2 border-primary p-6 space-y-4 shadow-sm">
